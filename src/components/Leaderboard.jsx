...
export default function Leaderboard({ data, onReload, isReloading, onWatchGhost, isLoadingGhost }) {
  ...
  return (
    <div style={{
      ...
      <p style={{ margin: '0 0 20px 0', fontSize: '0.8rem', color: '#8892b0', lineHeight: 1.4 }}>
        Scores are retrieved live from Shelby Storage. Click GHOST to race any player's recorded run.
      </p>
        ...
        <table style={{ width: '100%', borderCollapse: 'collapse', textAlign: 'left', fontSize: '0.9rem' }}>
          <thead>
            <tr style={{ borderBottom: '1px solid rgba(255,255,255,0.1)' }}>
              <th style={{ padding: '8px 0', color: '#8892b0', fontSize: '0.75rem', width: '40px' }}>RANK</th>
              ...
              <th style={{ padding: '8px 0', color: '#8892b0', fontSize: '0.75rem', textAlign: 'right' }}>GHOST</th>
            </tr>
          </thead>
          <tbody>
            {data.map((player, idx) => (
              ...
              >
                ...
                <td style={{ padding: '12px 0', textAlign: 'right' }}>
                  <button
                    onClick={() => onWatchGhost(player.wallet_address)}
                    ...
                    style={{
                      ...
                      fontFamily: 'Space Grotesk, sans-serif',
                      letterSpacing: '1px',
                      opacity: isLoadingGhost ? 0.5 : 1,
                    }}
                  >
                    {isLoadingGhost ? "..." : "GHOST"}
                  </button>
                </td>
              </tr>
            ))}
